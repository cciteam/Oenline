...
class MySQLBoucheDAO implements BoucheDAO
{
	...
	{
		$requete="INSERT INTO $this->nomTable (nomBouche, typeDescBouche, typeBouche, scoreBouche) VALUES ('$bouche->nomBouche', '$bouche->typeDescBouche', '$bouche->typeBouche', '$bouche->scoreBouche')";
	...
	{
		$requete="UPDATE $this->nomTable SET nomBouche='$bouche->nomBouche' , typeDescBouche='$bouche->typeDescBouche' , typeBouche='$bouche->typeBouche' , scoreBouche='$bouche->scoreBouche'  WHERE idBouche='$bouche->idBouche'";
		$this->connexion->executer($requete);
	}
